...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    sellHis = addCaracterAtStartOfKeys('0s', sellHis);
    buyHis = addCaracterAtStartOfKeys('0b', buyHis);
    prodChanges = addCaracterAtStartOfKeys('0m', prodChanges);

    Map<String, dynamic> historyList = {...sellHis, ...buyHis, ...prodChanges};// merge
    Map<String, dynamic> allItems = {};//clear

    /// //////////////////////////////////

    //if(json['name'] == 'baya 2'){
    //  order by time ///// new -> old
    List<MapEntry<String, dynamic>> list = historyList.entries.toList();
    list.sort((a, b) {
